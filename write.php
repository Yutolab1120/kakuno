...
if (!empty($_POST['btn_submit'])) {
  ...
  if (empty($error_message)) {
    ...
    if ($file_handle = fopen(FILENAME, "a")) {
      ...
      $success_message = '作品を投稿しました。創作お疲れさまでした！';
    }
  }
}
        ...
        <div class='foo foo--inside'>
          ...
          <form method="post">
            <div>
              ...
              <input class="tt_input" id="view_name" type="text" name="view_name" value="" style="border:none; font-weight:bolder ;" placeholder="記事タイトル">

            </div>
            <div>
              <label class="kiji" for="message"><b></b></label>
              <textarea class="kiji_input" id="message" name="message" style="border:none" placeholder="ご自由にお書きください。" onkeyup="ShowLength(value);"></textarea>
            </div>
            <input type="submit" name="btn_submit" value="投稿"><br><br>
          </form>
